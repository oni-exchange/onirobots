...
*/
contract OniProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberOniToReactivate;
    uint256 public numberOniToRegister;
    uint256 public numberOniToUpdate;
    ...
    constructor(
        IBEP20  _oniToken,
        uint256 _numberOniToReactivate,
        uint256 _numberOniToRegister,
        uint256 _numberOniToUpdate
    ) public {
        oniToken = _oniToken;
        numberOniToReactivate = _numberOniToReactivate;
        numberOniToRegister = _numberOniToRegister;
        numberOniToUpdate = _numberOniToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends ONI to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer ONI tokens to this contract
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer ONI token to this address
        oniToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberOniToUpdate
     ...
     * Callable only by owner admins.
     */
    function updateNumberOni(
        uint256 _newNumberOniToReactivate,
        uint256 _newNumberOniToRegister,
        uint256 _newNumberOniToUpdate
    ) external onlyOwner {
        numberOniToReactivate = _newNumberOniToReactivate;
        numberOniToRegister = _newNumberOniToRegister;
        numberOniToUpdate = _newNumberOniToUpdate;
    }

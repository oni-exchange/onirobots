...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.oni = await MockBEP20.deployed();
        ...
        await this.oni.transfer(bob, '2000', { from: minter });
        await this.oni.transfer(alice, '2000', { from: minter });
        await this.oni.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.oni.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.oni.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.oni.balanceOf(this.lotteryProxyAddress)).toString(), '418');
        ...
        // console.log('cake2:', (await this.oni.balanceOf(alice, {from: alice})).toString());
